...
/* Определяем Хром или Опера и их версии */
 $browser = new Browser();
 if( $browser->getBrowser() == Browser::BROWSER_CHROME && $browser->getVersion() >= 9 ) {
 //echo '<!-- You have CHROME version '.$browser->getVersion().'-->';
 $tail_pictures = 'webp';
   }
 elseif ($browser->getBrowser() == Browser::BROWSER_OPERA && $browser->getVersion() >= 11.10 ) {
	//echo '<!-- You have OPERA version '.$browser->getVersion().'-->'; 
	$tail_pictures = 'webp';
 }
 else {$tail_pictures = 'jpg';}