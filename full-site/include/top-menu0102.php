  ...
  ?>
   ...
   <!-- начало верхнего меню -->
             ...
             $('.lang_ua, .lang_en, .lang_ru, .lang_dropdown').mouseout(function(){
              ...
              <div class="call-phone">
                ...
                <div class="call_wrapper">
                  ...
                  <span class="call-number font28"><a class="ringo-phone" id="tT" href="tel:123123">(044) 290-73-88</a></span>
                </div>
          ...
          <div class="promotions_btn">
            <a href="/akcjn_cni/" class="promotions_btn__link"><?=$mes['menu-mes19'];?></a>
          </div>
        </div>
        ...
        <div class="my_menu my_menu_hidden">
          <div class="my_menu_wrap">
                ...
                <div class="left_top_item">
                  ...
                  <div class="left_top_item">
                    <span class='bigger__nolink'><?=$mes['menu-mes22']?></span>
                    ...
                    <a class="menu__link" href="<?=$l?>kommercheskaya/"><?=$mes['kom-mes-menu']?></a>
                  </div>
...
.promotions_btn__link {color: white;text-decoration: none;}
 a#tT{ pointer-events: none;color: white;text-decoration:none;}
