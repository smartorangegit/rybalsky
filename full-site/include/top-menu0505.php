             ...
             $('.lang_ua, .lang_en, .lang_ru, .lang_dropdown').mouseout(function(){
              ...
              <div class="call-phone">
                ...
                <div class="call_wrapper">
                  ...
                  <span class="call-number font28"><a class="ringo-phone" id="tT" href="tel:123123">(044) 498-02-00</a></span>
                </div>
        ...
        <div class="my_menu my_menu_hidden">
          <div class="my_menu_wrap">
                ...
                <div class="left_top_item">
                 ...
                 <!--realty-block -->
                  <div class="left_top_item realty-block clearfix">
	                 <!-- <span class='bigger__nolink realty-block__heading'></span> -->
                   <div class="realty-block-content">
                    <!--realty-block__left -->
                    <div class="left_top_item realty-block__item realty-block__item_left">
                    ...
                    <!--realty-block__rigth -->
	                   <div class="left_top_item realty-block__item realty-block__item_right">
