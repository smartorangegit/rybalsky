...
<body>
<?php include_once('include/call_service-department.php'); ?>
<div class="parking">
    <?php /*Google Tag Manager*/
    include_once('include/gtm2.php'); ?>
    <div class="loader">
        <div class="loader__background">
            <div class="loader__inner"><img <? AltImgAdd($mes['alt-logo']) ?> src="/img/icons/rb_logo_white.png"
                                                                              alt="<?= $mes['service-h1'] ?>"
                                                                              title="<?= $mes['service-h1'] ?>"></div>
        </div>
    </div>
    ...
    <div class="parking__container parking__container_1 parking__container_last">
        <div class="parking__text">
            ...
            <p><?= $mes['service-text-1'] ?></p>
            <p><?= $mes['service-list-1-1'] ?></p>
            <ul>
                <li>• <?= $mes['service-list-1-2'] ?></li>
                <li>• <?= $mes['service-list-1-3'] ?></li>
                <li>• <?= $mes['service-list-1-4'] ?></li>
            </ul>
        </div>
        <div class="parking__image parking__image_1">
            <img src="/img/service-department/service-department-1.jpg" alt="<?= $mes['service-h1'] ?>"
                 title="<?= $mes['service-h1'] ?>">
        </div>
    </div>
    ...
    <div class="services-contact">
        <p class="services-contact-list__head services-contact__text"><?= $mes['service-text-3'] ?></p>
        <ul class="services-contact-list">
            <li class="services-contact-list__item">
                <p class="services-contact-list__text">
                    <span class="services-contact-list__text_medium"> <?= $mes['service-text-4'] ?></span>
                </p>
                <p class="services-contact-list__text">
                    <span class="services-contact-list__text_medium"> <?= $mes['service-text-4-1'] ?></span>
                    <!-- <a href="tel:+380444940400" class="services-contact-list__link services-contact-list__link_phone">(044) 494-04-00</a> -->
                </p>
                <p class="services-contact-list__text">
                    <span class="services-contact-list__text_medium"> <?= $mes['service-text-4-2'] ?> </span>
                </p>
            </li>
            <li class="services-contact-list__item">
                <p class="services-contact-list__text">
                    <?= $mes['service-text-4-3'] ?>
                </p>
            </li>
        </ul>
    </div>
    ...
    <div class="button_center">
        <a id="call_ma_please_ctc" class="button callback button-blue button-call"
           href="#callback"> <?= $mes['service-button-text'] ?> </a>
    </div>
</div>
...
<?php /*Контактна форма*/
include_once('include/call_my.php'); ?>
