          ...
          <!--Фасад-->
            <div class="tooltip-content clearfix">
              <div class="tooltip-text">
                ...
                <div class="tool_sec">
                  <?=$mes['сease']?> 5<br>
                  <?=$mes['windows']?> - 51%<br><?=$mes['facade']?> - 2%
                </div>
                <!--Секція 6-->
                <div class="tool_sec">
                  <?=$mes['сease']?> 6<br>
          ...
          <!--Мережі-->
            <div class="tooltip-content clearfix">
              <div class="tooltip-text">
                ...
                <div class="tool_sec">
                  <?=$mes['сease']?> 3<br>
                  <?=$mes['inside']?> - 86%<br><?=$mes['exterior']?> - 23%
                </div>
                <!--Секція 4-->
                <div class="tool_sec">
                  <?=$mes['сease']?> 4<br>
                  <?=$mes['inside']?> - 75%<br><?=$mes['exterior']?> - 26%
                </div>
                <!--Секція 5-->
                <div class="tool_sec">
                  <?=$mes['сease']?> 5<br>
                  <?=$mes['inside']?> - 67%<br><?=$mes['exterior']?> - 5%
                </div>
                <!--Секція 6-->
                <div class="tool_sec">
                  <?=$mes['сease']?> 6<br>
          ...
          <div class="tooltip toolti p-effect-1"><span class="tooltip-item"><svg id="container2_3"></svg></span>
            <div class="tooltip-content clearfix"><!--Мережі-->
              <div class="tooltip-text">
                <div class="tool_sec"><!--Секція 1-->
                  <?=$mes['сease']?> 1<br>
                  <?=$mes['inside']?> - 59%<br><?=$mes['exterior']?> - 23%
                </div>
                <div class="tool_sec"><!--Секція 2-->
                  <?=$mes['сease']?> 2<br>
                  <?=$mes['inside']?> - 59%<br><?=$mes['exterior']?> - 0%
                </div>
