          ...
          <!--Фасад-->
            <div class="tooltip-content clearfix">
              <div class="tooltip-text">
                ...
                <div class="tool_sec">
                  <?=$mes['сease']?> 2<br>
                  <?=$mes['windows']?> - 98%<br><?=$mes['facade']?> - 72%
                </div>
                <!--Секція 3-->
                <div class="tool_sec">
                  <?=$mes['сease']?> 3<br>
                  <?=$mes['windows']?> - 96,67%<br><?=$mes['facade']?> - 72%
                </div>
                <!--Секція 4-->
                <div class="tool_sec">
                  <?=$mes['сease']?> 4<br>
                  <?=$mes['windows']?> - 96,67%<br><?=$mes['facade']?> - 70%
                </div>
                <!--Секція 5-->
                <div class="tool_sec">
                  <?=$mes['сease']?> 5<br>
            ...
            <div class="tooltip-content clearfix"><!--Фасад-->
              <div class="tooltip-text">
                <div class="tool_sec"><!--Секція 1-->
                  <?=$mes['сease']?> 1<br>
                  <?=$mes['windows']?> - 40%<br><?=$mes['inside']?> - 48%
                </div>
                ...
                <div class="tool_sec"><!--Секція 6-->
                  <?=$mes['сease']?> 6<br>
                  <?=$mes['windows']?> - 60,00%<br><?=$mes['inside']?> - 93%
                </div>
              </div>
            </div>
          </div>
