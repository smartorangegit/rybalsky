      ...
      <div class="block_timebar">
        ...
        <div class="tooltip-content clearfix">
          <div class="tooltip-text">
            ...
            <div class="tool_sec">
              <?=$mes['сease']?> 2<br>
              <?=$mes['work_to']?> 0,000 - 100%<br>
              <?=$mes['carcass']?> - 99,30%<br>
              <?=$mes['brickwork']?> - 96,5%<br>
              <?=$mes['interior_fittings']?> - 0%
            </div>
            <!--Секція 3-->
            <div class="tool_sec">
        ...
        <div class="tooltip-content clearfix">
          <div class="tooltip-text">
            ...
            <div class="tool_sec">
              <?=$mes['сease']?> 2<br>
              <?=$mes['windows']?> - 2,78%<br><?=$mes['facade']?> - 27,3%
            </div>
            <!--Секція 3-->
            <div class="tool_sec">
              <?=$mes['сease']?> 3<br>
              <?=$mes['windows']?> - 66,67%<br><?=$mes['facade']?> - 66%
            </div>
            <!--Секція 4-->
            <div class="tool_sec">
              <?=$mes['сease']?> 4<br>
              <?=$mes['windows']?> - 66,67%<br><?=$mes['facade']?> - 39,6%
            </div>
            <!--Секція 5-->
            <div class="tool_sec">
              <?=$mes['сease']?> 5<br>
              <?=$mes['windows']?> - 50,5%<br><?=$mes['facade']?> - 0%
            </div>
            <!--Секція 6-->
            <div class="tool_sec">
              <?=$mes['сease']?> 6<br>
        ...
        <div class="tooltip-content clearfix">
          <div class="tooltip-text">
            ...
            <div class="tool_sec">
              <?=$mes['сease']?> 2<br>
              <?=$mes['inside']?> - 40,45%<br><?=$mes['exterior']?> - 23%
            </div>
            <!--Секція 3-->
            <div class="tool_sec">
              <?=$mes['сease']?> 3<br>
              <?=$mes['inside']?> - 82,7%<br><?=$mes['exterior']?> - 23%
            </div>
            <!--Секція 4-->
            <div class="tool_sec">
              <?=$mes['сease']?> 4<br>
              <?=$mes['inside']?> - 43,18%<br><?=$mes['exterior']?> - 23%
            </div>
            <!--Секція 5-->
            <div class="tool_sec">
              <?=$mes['сease']?> 5<br>
      ...
      <div class="block_timebar">
        ...
        <div class="tooltip-content clearfix">
          <div class="tooltip-text">
            ...
            <div class="tool_sec">
              <?=$mes['сease']?> 1<br>
              <?=$mes['windows']?> - 2,5%<br><?=$mes['inside']?> - 10,5%
            </div>
            <!--Секція 2-->
            <div class="tool_sec">
              <?=$mes['сease']?> 2<br>
            ...
            <div class="tool_sec">
              <?=$mes['сease']?> 5<br>
              <?=$mes['windows']?> - 47,2%<br><?=$mes['inside']?> - 24,5%
            </div>
            <!--Секція 6-->
            <div class="tool_sec">
              <?=$mes['сease']?> 6<br>
              <?=$mes['windows']?> - 60,00%<br><?=$mes['inside']?> - 63,7%
            </div>
          </div>
        </div></span>
        ...
        <div class="tooltip-content clearfix">
          <div class="tooltip-text">
            ...
            <div class="tool_sec">
              <?=$mes['сease']?> 1<br>
              <?=$mes['inside']?> - 0%<br><?=$mes['exterior']?> - 23%
            </div>
            <!--Секція 2-->
            <div class="tool_sec">
              <?=$mes['сease']?> 2<br>
            ...
            <div class="tool_sec">
              <?=$mes['сease']?> 5<br>
              <?=$mes['inside']?> - 19,54%<br><?=$mes['exterior']?> - 23%
            </div>
            <!--Секція 6-->
            <div class="tool_sec">
              <?=$mes['сease']?> 6<br>
              <?=$mes['inside']?> - 36,36%<br><?=$mes['exterior']?> - 23%
            </div>
          </div>
        </div></span>
