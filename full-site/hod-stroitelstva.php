      ...
      <div class="block_timebar">
        ...
        <div class="tooltip-content clearfix">
          <div class="tooltip-text">
            ...
            <div class="tool_sec">
              <?=$mes['сease']?> 2<br>
              <?=$mes['windows']?> - 16,67%<br><?=$mes['facade']?> - 55%
            </div>
            <!--Секція 3-->
            <div class="tool_sec">
              <?=$mes['сease']?> 3<br>
              <?=$mes['windows']?> - 96,67%<br><?=$mes['facade']?> - 76%
            </div>
            <!--Секція 4-->
            <div class="tool_sec">
              <?=$mes['сease']?> 4<br>
              <?=$mes['windows']?> - 96,67%<br><?=$mes['facade']?> - 55%
            </div>
            <!--Секція 5-->
            <div class="tool_sec">
              <?=$mes['сease']?> 5<br>
        ...
        <div class="tooltip-content clearfix">
          <div class="tooltip-text">
            ...
            <div class="tool_sec">
              <?=$mes['сease']?> 2<br>
              <?=$mes['inside']?> - 62%<br><?=$mes['exterior']?> - 23%
            </div>
            <!--Секція 3-->
            <div class="tool_sec">
              <?=$mes['сease']?> 3<br>
      ...
      <div class="block_timebar">
        ...
        <div class="tooltip-content clearfix">
          <div class="tooltip-text">
            ...
            <div class="tool_sec">
              <?=$mes['сease']?> 1<br>
              <?=$mes['windows']?> - 2,5%<br><?=$mes['inside']?> - 18%
            </div>
            <!--Секція 2-->
            <div class="tool_sec">
              <?=$mes['сease']?> 2<br>
            ...
            <div class="tool_sec">
              <?=$mes['сease']?> 5<br>
              <?=$mes['windows']?> - 53%<br><?=$mes['inside']?> - 42%
            </div>
            <!--Секція 6-->
            <div class="tool_sec">
              <?=$mes['сease']?> 6<br>
              <?=$mes['windows']?> - 60,00%<br><?=$mes['inside']?> - 75%
            </div>
          </div>
        </div></span>
        ...
        <div class="tooltip-content clearfix">
          <div class="tooltip-text">
            ...
            <div class="tool_sec">
              <?=$mes['сease']?> 5<br>
              <?=$mes['inside']?> - 23%<br><?=$mes['exterior']?> - 23%
            </div>
            <!--Секція 6-->
            <div class="tool_sec">
              <?=$mes['сease']?> 6<br>
              <?=$mes['inside']?> - 53%<br><?=$mes['exterior']?> - 23%
            </div>
          </div>
        </div></span>
...
<div class="stroy_item stroy_item_left stroy48">
  <div class="stroy_overlay" id='48'>
    <a id='group48' href="/img/quart/18_06_2018/1.jpg" class="fancybox" data-fancybox="group47" data-caption="<?=$mes['s-mes63']?>"></a>
