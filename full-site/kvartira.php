...
<html <?=$mes['i-mes8']?>>
  ...
  <meta name="viewport" content="width=device-width">
	<meta name="description" content="<?=$mes['pl-mes1-description']; ?>">
  <title><?=$mes['pl-mes1-title']?></title>
          ...
          <div class="slider-content clearfix">
                <div class="checkboxes_container">
                  ...
                  <div class="checkboxes__building">
					...
					<input id="checkbox__building4" class="checkbox__building filter__checkbox"  type="checkbox" value="11"/>
                    <label for="checkbox__building4" class="checkbox__text">11</label>
                  </div>
                  <div class="checkboxes__section">
                    ...
                    <input id="checkbox__section7" class="checkbox__section filter__checkbox"  type="checkbox" value="7"/>
                    <label for="checkbox__section7" class="checkbox__text">7</label>
                    <input id="checkbox__section8" class="checkbox__section filter__checkbox"  type="checkbox" value="8"/>
                    <label for="checkbox__section8" class="checkbox__text">8</label>
                  </div>
                </div>
