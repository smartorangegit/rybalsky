  ...
  <body>
    ...
    <!-- MAIN-section -->
        ...
        <div>
            <div class="commercProperty__container">
              <div class="commercProperty__text">
                  <h2 class="commercProperty__heading"><?=$mes['cp-text17'];?></h2>
                  <p class="commercProperty__paragraph"><?=$mes['cp-text18'];?></p>
				  <p class="commercProperty__paragraph"><?=$mes['cp-text18_1'];?></p>
        ...
        <div>
            <div class="commercProperty__container">
              ...
              <div class="commercProperty__text">
                ...
                <div>
                  <p class="commercProperty__paragraph"><?=$mes['cp-text20'];?></p>
                </div>
              </div>
            </div>
        </div>
      ...
      <section class="commerc__advantages">
        <div class="commercProperty__container">
              <div class="commercProperty__text">
                  <h2 class="commercProperty__heading"><?=$mes['cp-text21'];?></h2>
                  <p class="commercProperty__paragraph"><?=$mes['cp-text22'];?></p>
				  <p class="commercProperty__paragraph"><?=$mes['cp-text22_1'];?></p>
        ...
        <div>
            <div class="commercProperty__container">
              ...
              <div class="commercProperty__text">
                ...
                <div>
                  <p class="commercProperty__paragraph"><?=$mes['cp-text31'];?></p>
				  <p class="commercProperty__paragraph"><?=$mes['cp-text32'];?></p>
				  <p class="commercProperty__paragraph"><?=$mes['cp-text33'];?></p>
                </div>
              </div>
            </div>
        </div>
      ...
      <section class="variants">
        <div>
            <div class="commercProperty__container">
              <div class="commercProperty__text">
                  <h2 class="commercProperty__heading"><?=$mes['cp-text34'];?></h2>
                  <p class="commercProperty__paragraph"><?=$mes['cp-text35'];?></p>
				  <p class="commercProperty__paragraph"><?=$mes['cp-text36'];?></p>

              </div>
              <div class="commercProperty__image">
                  <img src="/img/commercial/r8.jpg" alt="Office">
              </div>
            </div>
        </div>
      </section>
        ...
        <div>
            <div class="commercProperty__container">
              ...
              <div class="commercProperty__text">
                ...
                <div>
                  <p class="commercProperty__paragraph"><?=$mes['cp-text38'];?></p>
				  <p class="commercProperty__paragraph"><?=$mes['cp-text39'];?></p>
				  <p class="commercProperty__paragraph"><?=$mes['cp-text40'];?></p>
                </div>
              </div>
            </div>
        </div>
      ...
      <section class="commerc__slider">
        <div class="partners">
          <h2 class="partners__heading"><?=$mes['cp-sale-slider-heading']?></h2>
          <div class="partners-slider-wrap">
            <ul class="partners-slider owl-carousel">
              <li class="partners-slider__item">
                <a href="https://bristol.house/<?if($url_str[1]=='ru'){echo $url_str[1].'/';}?>" target="_blank" class="partners-slider__link">
              ...
              <li class="partners-slider__item">
                <a href="https://einstein.house/<?if($url_str[1]=='ru'){echo $url_str[1].'/';}?>" target="_blank" class="partners-slider__link">
                  <img src="/img/commercial/icons/EINSTEIN-logo-blue.svg" alt="" class="partners-slider__image partners-slider__image-einstein">
                </a>
              <li class="partners-slider__item">
                <a href="http://new-york.com.ua/<?if($url_str[1]=='ru'){echo $url_str[1].'/';}?>" target="_blank" class="partners-slider__link">
              ...
              <li class="partners-slider__item">
                <a href="https://sanfrancisco.com.ua/<?if($url_str[1]=='ru'){echo $url_str[1].'/';}?>" target="_blank" class="partners-slider__link">
              ...
              <li class="partners-slider__item">
                <a href="http://resident.house/<?if($url_str[1]=='ru' || $url_str[1]=='en'){echo $url_str[1].'/';}?>" target="_blank" class="partners-slider__link">
              ...
              <li class="partners-slider__item">
                <a href="https://chicago.kiev.ua/<?if($url_str[1]=='ru' || $url_str[1]=='en'){echo $url_str[1].'/';}?>" target="_blank" class="partners-slider__link">
                       ...
                       <div class="call_my_bottom">
                         ...
                         <div class="tabs__inner__contacts">
						   ...
						   <div class="commercial__number">
                             ...
                             <p><a class="ringo-phone" id="tT_" href="tel:0443911800">(044) 391-18-00</a></p>
						   </div>
