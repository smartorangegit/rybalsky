		...
		return $(this).each(function(){
        	var block = $(this);
          	$(document).keydown(function(e){
	        	...
	        	block.unbind('click');//.css({'-moz-user-select':'none','-webkit-user-select': 'none','user-select': 'none'}) //тогда текст не выделяется после нажатия ctrl
	        	if (e.ctrlKey) {
...
})(jQuery);//Запуск функции shift select
