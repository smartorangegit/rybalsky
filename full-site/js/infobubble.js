...
InfoBubble.prototype.arrowPosition_changed = function() {
  ...
  // Andrey edited here
  this.arrowOuter_.style['top'] = -121 + 'px';
  this.arrowOuter_.style['transform'] = 'rotate(90deg)';
  this.arrowOuter_.style['z-index'] = '-1';
...
InfoBubble.prototype.backgroundColor_changed = function() {
  ...
  // Andrey was here
  this.arrowInner_.style['top'] = -121 + 'px';
  this.arrowInner_.style['transform'] = 'rotate(90deg)';
  this.arrowInner_.style['z-index'] = '-1';
  // Andrey was here
