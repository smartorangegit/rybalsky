...
<html <?=$mes['i-mes8']?>>
  ...
  <meta name="viewport" content="width=device-width">
	<meta name="description" content="<?=$mes['kv-mes-description-8']; ?>">
  <title><?=$mes['kv-mes-title-8']?></title>
...
<body>
  <style media="screen">
    body{height: 100%;}
    .container{  min-height: 100%;  background: url("/img/app-bg.jpg") center 0 no-repeat;  background-size: cover;  background-attachment: fixed;}
    .more_news_link a{  color: white;  text-decoration: none;  font-size: 24px;  display: block;}
